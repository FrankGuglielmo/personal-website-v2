...
export const BlogData = [
  {
    ...
    content: `
      ...
      <p>It's good if they <b>release a packaged online and story mode</b> inside the game, as on day one, there will be a lot of people playing offline, not affecting any online servers. Most games tend to have separate releases for online and offline versions of the game for this purpose, since it'll reduce the amount of load for online servers. Players may just wait until the weekend to play, which will be a major test for their servers. Giving players the option to dive into the single-player story mode right away means a significant portion of the player base won't be hammering the online servers on day one.</p>
